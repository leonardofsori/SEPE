...
const String HOMEPAGE = "<nav class=\"menu1\"><h1>PISO 1</h1><ul><li>Sala:<li><ul><li><p>Lampada</p><form action=\"/cmd1\" method=\"get\"><button>Desligado</button></form><br/><form action=\"/cmd2\" method=\"get\"><button>Liga</button></form><br/><li></ul><li>Cozinha:<li><ul><li><p>lampada</p> <form action=\"/cmd3\" method=\"get\"><button>Desliga</button></form><br/><form action=\"/cmd4\" method=\"get\"><button>Liga</button></form><br/><li><li><p>Chaleira</p> <form action=\"/cmd5\" method=\"get\"><button>Desliga</button></form><br/> <form action=\"/cmd6\" method=\"get\"><button>Liga</button></form><br/><li></ul></ul></nav><nav class=\"menu2\"<h1>PISO 2</h1> <ul><li><Quarto Casal:<li><ul><li><p>Lampada</p> <form action=\"/cmd7\" method=\"get\"><button>Desligado</button></form><br/> <form action=\"/cmd8\" method=\"get\"><button>Liga</button></form><br/> <li></ul><li>Quanto Cranças:<li><ul><li><p>Lampada</p> <form action=\"/cmd9\" method=\"get\"><button>Desligado</button></form><br/> <form action=\"/cmd10\" method=\"get\"><button>Liga</button></form><br/><li></ul></ul></nav>";
